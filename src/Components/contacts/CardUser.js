    ...
    <div className='border-none w-full h-full bg-[#FFFFFF] overflow-y-auto'>
      ...
      <div className='ml-9 mt-5 gap-3'>
        ...
        <div className='flex w-9 h-9 m-2 gap-4 items-center'>
          <img src='images/profil-image.webp' className="rounded-full" alt="image" />
          <img src='images/profil-image.webp' className="rounded-full" alt="image" />
          <img src='images/profil-image.webp' className="rounded-full" alt="image" />
          <img src='images/profil-image.webp' className="rounded-full" alt="image" />
        </div>
      ...
      {users.map((user) => (
        <div key={user.id} onClick={() => handlechat(user.id, user.user.username)} className='hover:bg-[#F8E8FF] cursor-pointer bg-opacity-100 flex items-center justify-between border border-gray mb-3 ml-9 mt-3 mr-9 p-3 rounded-lg relative'>
          <div className="w-9 h-9 overflow-hidden">
            {user.image ? (
              <img src={`http://127.0.0.1:8000${user.image}`} className="w-full h-full rounded-full" alt="image" />
            ) : (
              <img src='images/profil-image.webp' className="w-full h-full rounded-full" alt="image" />
            )}
