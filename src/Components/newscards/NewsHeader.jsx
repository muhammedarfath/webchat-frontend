...
function NewsHeader({ onCategoryChange }) {
  ...
  return (
    <>
      <div className="w-full font-serif items-center justify-evenly flex border-b-2 h-44">
        <div className="hidden md:block lg:w-1/4 lg:flex flex-col p-7 items-start">
          <Autocomplete
            ...
            variant="bordered"
          >
            <AutocompleteItem onClick={handleCategorySelect}>
              World
            </AutocompleteItem>
            <AutocompleteItem onClick={handleCategorySelect}>
              Busines
          ...
          <h1 className="p-3 font-bold">
            Tuesday, Jul 16, 2024 <br /> <small> TODAY'S PAPER</small>
          </h1>
        </div>
        ...
        <div className="flex items-center w-3/4 justify-evenly">
          <div className="flex items-center  flex-col">
            <small className="pt-6">
              English | हिंदी| मराठी| മലയാളം| 中国人
            </small>
            <hr className="w-full" />
          ...
          <div className="hidden lg:flex flex-col p-4">
            <button className="bg-[#1D9BF0] p-3 flex justify-center items-center gap-3 text-white rounded-md">
              <span className="hidden lg:block">Newsletter</span>
              <SlEnvolopeLetter />
            </button>
      ...
      <div className="cursor-pointer lg:text-lg text-xs sticky top-0 bg-white z-10  h-9 w-full border-b-2 flex gap-6 items-center justify-evenly overflow-x-scroll scrollbar-hide">
